...
function rayCasting() {
    ...
    for(let rayCount = 0; rayCount < data.projection.width; rayCount++) {
        ...
        // Draw
        drawLine(rayCount, 0, rayCount, data.projection.halfHeight - wallHeight, "#AFFFFD");
        drawTexture(rayCount, wallHeight, texturePositionX, texture);
        drawLine(rayCount, data.projection.halfHeight + wallHeight, rayCount, data.projection.height, "#FFFDAF");
